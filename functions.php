...
if ( ! function_exists( 'fourtyau_starter_theme_setup' ) ) :
	...
	function fourtyau_starter_theme_setup() {
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'fourtyau-starter-theme' ),
			)
		);
 ...
 */
function fourtyau_starter_theme_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'fourtyau-starter-theme' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'fourtyau-starter-theme' ),
...
add_action( 'widgets_init', 'fourtyau_starter_theme_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function fourtyau_starter_theme_scripts() {
	wp_enqueue_style( 'fourtyau-starter-theme-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'fourtyau-starter-theme-style', 'rtl', 'replace' );

	wp_enqueue_script( 'fourtyau-starter-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
